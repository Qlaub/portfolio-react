...
function Footer() {
  return (
    <footer className="flex fixed bottom-2 md:bottom-10 md:right-10 w-full justify-center md:w-fit md:bg-secondary md:p-6 rounded-2xl md:shadow-xl opacity-70 transition ease-in-out duration-300 hover:opacity-100 md:opacity-100">
      <ul className="flex items-center md:flex-col gap-10 md:gap-6 bg-secondary md:p-0 p-4 rounded-2xl shadow-4xl md:shadow-none">
