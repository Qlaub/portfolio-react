  ...
  return (
    <section className="mx-2 mt-10 mb-24 md:ml-24 md:mr-48 lg:ml-32 lg:mr-96">
      ...
      <div className="leading-7 text-lg text-tertiary">
        <p className="pb-5">I began pursuing development in 2020 after performing as a classical cellist 
        ...
        <p>I am now a graduate of the Full Stack Flex Coding Boot Camp at the University of North Carolina, 
